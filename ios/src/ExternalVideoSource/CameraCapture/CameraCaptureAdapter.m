...
didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer
    ...
    ZoomInstantSDKVideoRawDataRotation rotate = ZoomInstantSDKVideoRawDataRotationNone;
    ...
    switch (orientation)
    {
        case UIInterfaceOrientationLandscapeLeft:
            rotate = ZoomInstantSDKVideoRawDataRotationNone;
            break;
            
        case UIInterfaceOrientationPortraitUpsideDown:
            rotate = ZoomInstantSDKVideoRawDataRotation270;
            break;
            
        case UIInterfaceOrientationLandscapeRight:
            rotate = ZoomInstantSDKVideoRawDataRotation180;
            break;
            
        case UIInterfaceOrientationPortrait:
            rotate = ZoomInstantSDKVideoRawDataRotation90;
            break;
