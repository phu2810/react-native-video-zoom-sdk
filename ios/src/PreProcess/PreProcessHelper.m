...
+ (void)addWaterMark:(ZoomInstantSDKPreProcessRawData *)rawData waterImage:(UIImage *)waterImage wateri420:(unsigned char *)wateri420 offX:(int)off_x offY:(int)off_y enableTransparent:(BOOL)enableTransparent
{
